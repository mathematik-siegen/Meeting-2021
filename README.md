This is the website for the [Meeting 2021](https://mathematik-siegen.github.io/Meeting-2021).
...
```
  git clone https://github.com/mathematik-siegen/Meeting-2021
  cd Meeting-2021
  jekyll serve -w
```
...
1. Copy the data of the previous worhsop into a new repository.
   Add that repository under a suitable name at https://github.com/mathematik-siegen/
